const MouseRightIcon = ({ color = 'var(--white)', width = 40, opacity = 1, strokeWidth = 1, className }) => {
  const ratio = 41.9 / 41.9
  const height = width / ratio

  return (
    <div className={`desktop-icon SVG ${className}`} style={{ height: height + 'px', width: width + 'px' }}>
      <svg id="MouseRightIcon" data-name="Mouse-right-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.9 41.9">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.9 41.9">
          <path
            d="M20.95 18.33a2.39 2.39 0 0 0 2.39-2.39v-3.52a2.39 2.39 0 0 0-2.39-2.39V2.35c6.58 0 11.91 5.33 11.91 11.91v10.67H20.95v-6.6Z"
            fill={color}
            opacity="0.25"
          />
          <path
